...
local message_type_names = {
	...
	[14] = "CLIENT_CLOSE_APP",
	[16] = "NEW_MEMBER_CONFIRM",
	[17] = "NEW_MEMBER_REJECT"
}
...
local ring_fields =
{
	...
	category_management_message_extra_info = ProtoField.int64 ("ring.category_management_message.extra_info", "Extra info", base.DEC),
...
dissectRING = function (tvbuf, pktinfo, root, offset)
	...
	elseif msg_type == 3 or msg_type == 4 or msg_type == 5 or msg_type == 6 or msg_type == 7 or msg_type == 8 or msg_type == 16 or msg_type == 17 then
		...
		tree:add_le(ring_fields.category_management_message_extra_info, tvbuf:range(inner_offset, 8))
		inner_offset = inner_offset + 8
